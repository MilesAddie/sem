...
public class AppIntegrationTest
{
    ...
    void testGetCountriesPopulationHighestToLowestWithN()
    {
        ...
        assertEquals(country.getCode(), "IDN");
        assertEquals(country.getName(), "Indonesia");
        assertEquals(country.getContinent(), "Asia");
        assertEquals(country.getRegion(), "Southeast Asia");
        assertEquals(country.getSurfaceArea(), 1904569.00);
        assertEquals(country.getIndepYear(), 1945);
        assertEquals(country.getPopulation(), 212107000);
        assertEquals(country.getLifeExpectancy(), 68.0);
        assertEquals(country.getGnp(), 84982.00);
        assertEquals(country.getGnpOld(), 215002.00);
        assertEquals(country.getLocalName(), "Indonesia");
        assertEquals(country.getGovernmentForm(), "Republic");
        assertEquals(country.getHeadOfState(), "Abdurrahman Wahid");
        assertEquals(country.getCapital(), "939");
        assertEquals(country.getCode2(), "ID");
    }
    ...
    void testGetCountriesPopulationByContinentHighestToLowestWithN()
    {
        ...
        assertEquals(country.getContinent(), "Europe");
        assertEquals(country.getRegion(), "Western Europe");
        assertEquals(country.getSurfaceArea(), 551500.0);
        assertEquals(country.getIndepYear(), 843);
        assertEquals(country.getPopulation(), 59225700);
        assertEquals(country.getLifeExpectancy(), 78.80000305175781);
        assertEquals(country.getGnp(), 1424285.0);
        assertEquals(country.getGnpOld(), 1392448.00);
        assertEquals(country.getLocalName(), "France");
        assertEquals(country.getGovernmentForm(), "Republic");
        assertEquals(country.getHeadOfState(), "Jacques Chirac");
        assertEquals(country.getCapital(), "2974");
        assertEquals(country.getCode2(), "FR");
    }
    ...
    void testGetCountriesPopulationByRegionHighestToLowestWithN()
    {
        ...
        assertEquals(country.getCode(), "PRI");
        assertEquals(country.getName(), "Puerto Rico");
        assertEquals(country.getContinent(), "North America");
        assertEquals(country.getRegion(), "Caribbean");
        assertEquals(country.getSurfaceArea(), 8875.0);
        assertEquals(country.getIndepYear(), 0);
        assertEquals(country.getPopulation(), 3869000);
        assertEquals(country.getLifeExpectancy(), 75.5999984741211);
        assertEquals(country.getGnp(), 34100.00);
        assertEquals(country.getGnpOld(), 32100.00);
        assertEquals(country.getLocalName(), "Puerto Rico");
        assertEquals(country.getGovernmentForm(), "Commonwealth of the US");
        assertEquals(country.getHeadOfState(), "George W. Bush");
        assertEquals(country.getCapital(), "2919");
        assertEquals(country.getCode2(), "PR");
    }
    ...
    void testGetCitiesPopulationHighestToLowestWithN()
    {
        ...
        assertEquals(city.getId(), 1890);
        assertEquals(city.getName(), "Shanghai");
        assertEquals(city.getCountryCode(), "CHN");
        assertEquals(city.getDistrict(), "Shanghai");
        assertEquals(city.getPopulation(), 9696300);
    }
    ...
    void testGetCitiesPopulationByContinentHighestToLowestWithN()
    {
        ...
        assertEquals(city.getId(), 3068);
        assertEquals(city.getName(), "Berlin");
        assertEquals(city.getCountryCode(), "DEU");
        assertEquals(city.getDistrict(), "Berliini");
        assertEquals(city.getPopulation(), 3386667);
    }
    ...
    void testGetCitiesPopulationByRegionHighestToLowestWithN()
    {
        ...
        assertEquals(city.getId(), 2919);
        assertEquals(city.getName(), "San Juan");
        assertEquals(city.getCountryCode(), "PRI");
        assertEquals(city.getDistrict(), "San Juan");
        assertEquals(city.getPopulation(), 434374);
    }
    ...
    void testGetCitiesPopulationByCountryHighestToLowestWithN()
    {
        ...
        assertEquals(city.getId(), 459);
        assertEquals(city.getName(), "Liverpool");
        assertEquals(city.getCountryCode(), "GBR");
        assertEquals(city.getDistrict(), "England");
        assertEquals(city.getPopulation(), 461000);
    }
    ...
    void testGetCitiesPopulationByDistrictHighestToLowestWithN()
    {
        ...
        assertEquals(city.getId(), 461);
        assertEquals(city.getName(), "Sheffield");
        assertEquals(city.getCountryCode(), "GBR");
        assertEquals(city.getDistrict(), "England");
        assertEquals(city.getPopulation(), 431607);
    }
    ...
    void testGetCapitalCitiesPopulationHighestToLowestWithN()
    {
        ...
        assertEquals(city.getId(), 3580);
        assertEquals(city.getName(), "Moscow");
        assertEquals(city.getCountryCode(), "RUS");
        assertEquals(city.getDistrict(), "Moscow (City)");
    ...
    void testGetCapitalCitiesPopulationByContinentHighestToLowestWithN()
    {
        ...
        assertEquals(city.getId(), 653);
        assertEquals(city.getName(), "Madrid");
        assertEquals(city.getCountryCode(), "ESP");
        assertEquals(city.getDistrict(), "Madrid");
